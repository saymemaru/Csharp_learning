    ...
    public class HDevelopExport
    {
        ...
        private void action()
        {
            ...
            try
            {
                ...
                hv_PoseOut.Dispose();
                visualize_object_model_3d(hv_WindowHandle, hv_RawSence, new HTuple(), new HTuple(),
                ...
                HDevWindowStack.Push(hv_WindowHandle);
                hv_PoseOut.Dispose();
                visualize_object_model_3d(hv_WindowHandle, hv_SampledModel, new HTuple(), new HTuple(),
                    ((new HTuple("lut")).TupleConcat("intensity")).TupleConcat("disp_pose"),
                    ((new HTuple("color1")).TupleConcat("coord_z")).TupleConcat("true"), new HTuple(),
                    new HTuple(), new HTuple(), out hv_PoseOut);
                ...
                hv_PoseOut.Dispose();
                visualize_object_model_3d(hv_WindowHandle, hv_ObjectModel3DSelected, new HTuple(),
                ...
                hv_PoseOut.Dispose();
                visualize_object_model_3d(hv_WindowHandle, hv_ObjectModel3DRigidTrans, new HTuple(),
                    new HTuple(), ((new HTuple("lut")).TupleConcat("intensity")).TupleConcat(
                    "disp_pose"), ((new HTuple("color1")).TupleConcat("coord_z")).TupleConcat(
                    "true"), new HTuple(), new HTuple(), new HTuple(), out hv_PoseOut);
                ...
                {
                    hv_PoseOut.Dispose();
                    visualize_object_model_3d(hv_WindowHandle, hv_TriangulatedRawSence.TupleConcat(
